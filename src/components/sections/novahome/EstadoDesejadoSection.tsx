...
export function EstadoDesejadoSection() {
  return (
    <section className="py-16 sm:py-24 bg-white relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-emerald-500/4 rounded-full -translate-y-1/2 blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <Reveal delay={0.1}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
                Torne o Bitrix24{' '}
                <span className="text-emerald-600">a fonte única da verdade da sua empresa.</span>
              </h2>
            </Reveal>
          ...
          <Reveal delay={0.3}>
            <div className="grid sm:grid-cols-2 gap-5">
              {MUDANCAS.map((mudanca, index) => (
                <div
                  key={index}
                  className="group p-6 bg-gradient-to-br from-emerald-50/50 to-white rounded-2xl border border-emerald-200/40 hover:border-emerald-300 shadow-sm hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="w-12 h-12 rounded-xl bg-emerald-500/10 group-hover:bg-emerald-500/20 flex items-center justify-center mb-4 transition-colors">
                    <mudanca.icon className="w-6 h-6 text-emerald-600" />
                  </div>
          ...
          <Reveal delay={0.4}>
            <div className="mt-12 text-center">
              <div className="inline-flex items-center gap-3 px-6 py-4 bg-emerald-50 border border-emerald-200/60 rounded-2xl">
                <CheckCircle className="w-5 h-5 text-emerald-600" />
                <p className="text-gray-700">
                  <strong className="text-emerald-700">Esse é o estado desejado.</strong> E é isso
