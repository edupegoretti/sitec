...
export function OrganizationJsonLd() {
  const schema = {
    ...
    image: 'https://zopu.com.br/images/og-image.png',
    sameAs: [
      'https://www.linkedin.com/company/zopu',
      'https://www.instagram.com/zopuoficial',
      'https://www.youtube.com/@zopuoficial',
    ],
    contactPoint: [
      {
        '@type': 'ContactPoint',
        telephone: '+55-11-4040-4995',
        contactType: 'sales',
        areaServed: 'BR',
...
export function LocalBusinessJsonLd() {
  const schema = {
    ...
    name: 'Zopu - Parceiro Bitrix24',
    description: 'Implementação de Bitrix24 com Metodologia Fluidsales. 96% de retenção anual.',
    url: 'https://zopu.com.br',
    telephone: '+55-11-4040-4995',
    priceRange: '$$',
    address: {
