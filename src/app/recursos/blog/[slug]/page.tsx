...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const canonical = post.seo?.canonical ?? `/recursos/blog/${post.slug}`
...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  const absoluteUrl = `https://zopu.com.br/recursos/blog/${post.slug}`
    ...
    <main className="pt-20 lg:pt-24">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Recursos', url: 'https://zopu.com.br/recursos' },
          { name: 'Blog', url: 'https://zopu.com.br/recursos/blog' },
